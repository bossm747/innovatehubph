    ...
    <section className="py-16 md:py-20 px-4 md:px-6 bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          {/* Contact Information Section - 2/3 width on desktop */}
          <div className="md:col-span-2 fade-up">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8 text-sm text-gray-500 flex-wrap">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 max-w-xl">
          ...
          {/* Contact Us Component - 1/3 width on desktop */}

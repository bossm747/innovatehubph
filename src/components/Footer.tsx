...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-white py-16" style={{ marginBottom: 0 }}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">Unit 13 InnovateHub Commercial Building, National Highway, San Antonio, San Pascual Batangas.</span>
              </li>

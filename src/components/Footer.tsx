            ...
            <form className="mt-6 space-y-3">
              <div className="flex">
                <input 
                  ...
                  className="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-l-md focus:outline-none focus:ring-1 focus:ring-innovate-500 focus:border-innovate-500"
                />
                <button 
                  type="submit" 
                  className="px-4 py-2 bg-innovate-600 text-white rounded-r-md hover:bg-innovate-700 transition-colors"
                >
                  Subscribe
                </button>
              </div>
